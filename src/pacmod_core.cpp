...
//const int64_t AS::Drivers::PACMod::TurnSignalCmdMsg::CAN_ID = 0x63;           // Delete
//const int64_t AS::Drivers::PACMod::TurnSignalRptMsg::CAN_ID = 0x64;           // Delete
//const int64_t AS::Drivers::PACMod::ShiftCmdMsg::CAN_ID = 0x65;                // Delete
//const int64_t AS::Drivers::PACMod::ShiftRptMsg::CAN_ID = 0x66;                // Delete
...
const int64_t AS::Drivers::PACMod::SteerRptMsg::CAN_ID = 0x85;                // Delete
const int64_t AS::Drivers::PACMod::VehicleSpeedRptMsg::CAN_ID = 0x6F;
const int64_t AS::Drivers::PACMod::VehicleSpeedCmdMsg::CAN_ID = 0x86;
...
//const int64_t AS::Drivers::PACMod::WiperCmdMsg::CAN_ID = 0x90;                // Delete
//const int64_t AS::Drivers::PACMod::WiperRptMsg::CAN_ID = 0x91;                // Delete
...
void VehicleSpeedCmdMsg::encode(double vehicle_speed, bool vehicle_speed_valid)
{
  ...
  temp = std::round(vehicle_speed * 1000);
  data[0] = (temp & 0x0000FF00) >> 8;
  data[1] = (temp & 0x000000FF);
  data[2] == vehicle_speed_valid;
}
